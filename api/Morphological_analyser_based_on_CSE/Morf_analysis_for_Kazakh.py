...
import xlrd
import db
def stemming_with_lexicon(text_fn, affixes_fn, stopwords_fn, stems_fn, stop_stems):
    ...
    def sorting_affixes(file_name):
        ...
        affixes_wb = xlrd.open_workbook(file_name)
...
# добавить with
        ...
        # print("stop_stem_file:", stop_stem_file)
    ...
    def stemming(tfile_name, affixes, stopwords_file_name, sfile_name):
        text_file = tfile_name
        stopwords_file_name = os.path.join(os.path.dirname(__file__), stopwords_file_name)
...
def segmentation(text, affixes_fn):
    ...
    for word in text_fseg:
        ...
        affixes_fn = os.path.join(os.path.dirname(__file__), affixes_fn)
